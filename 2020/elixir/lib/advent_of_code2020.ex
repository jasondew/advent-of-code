defmodule AdventOfCode2020 do
  ...
  def day_eight() do
    ...
    Benchee.run(
      %{
        part_one: fn -> DayEight.part_one(input) end,
        part_two: fn -> DayEight.part_two(input) end
      },
      formatters: [
        {Benchee.Formatters.Console, comparison: false}
      ]
  ...
  def day_nine() do
    ...
    Benchee.run(
      %{
        part_one: fn -> DayNine.part_one(input) end,
        part_two: fn -> DayNine.part_two(input) end
      },
      formatters: [
        {Benchee.Formatters.Console, comparison: false}
      ]
